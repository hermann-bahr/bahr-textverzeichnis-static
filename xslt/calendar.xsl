                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header" style="text-align:center">
                                ...
                                <a>
                                    <i class="fas fa-info"
                                        title="Textverzeichnis nach Tagen suchen"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Dieser Kalender zeigt alle Texte der vorliegenden Edition. Sie
                                    sind aufgeteilt in die Farben rot (Artikel), blau (Buchbeiträge), 
                                    grün (Rezensionen) und braun (sonstige Texte).</p>
                                </div>
