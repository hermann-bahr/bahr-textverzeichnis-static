                        ...
                        <ul id="main-menu" class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="projekt.html">Zur Edition</a></li>
                                    <li><a class="dropdown-item" href="hinweise.html">Hinweise</a></li>
                                    <li><a class="dropdown-item" href="pseudonyme.html">Pseudonyme</a></li>
                                    <li><a title="Links" href="https://bahr.univie.ac.at"
                                        class="nav-link">Projektwebsite</a></li>
                                    <li><a title="Links"
                                        href="https://github.com/hermann-bahr/bahr-textverzeichnis-data"
                                        class="nav-link">Daten auf gitHub</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
